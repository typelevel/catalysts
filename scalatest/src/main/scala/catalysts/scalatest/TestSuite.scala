...
import org.scalatest.{FunSpec, Matchers, PropSpec, Tag}
 ...
 */
trait TestSuite extends FunSpec with LawsChecks  with FSuite[ScalatestKit] with ScalatestTestSpec
